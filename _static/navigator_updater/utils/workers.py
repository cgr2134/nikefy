...
class TaskWorker(QtCore.QRunnable):
    ...
    __detached_workers__: typing_extensions.Final[typing.MutableSet['TaskWorker']] = set()
    ...
    def detach(self) -> None:
        """
        Start worker in a detached mode.

        This method ensures that worker will not be affected by garbage collector.
        """
        self.__detached_workers__.add(self)
        self.signals.sig_done.connect(lambda: self.__detached_workers__.discard(self))
        self.start()
