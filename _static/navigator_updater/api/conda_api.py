...
from navigator_updater.utils import ansi_utils
...
class ProcessWorker(QObject):  # pylint: disable=too-many-instance-attributes
    ...
    def communicate(self):
        ...
        stdout = ansi_utils.escape_ansi(stdout)
        stderr = ansi_utils.escape_ansi(stderr)
...
class _CondaAPI(QObject):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def get_repodata(  # pylint: disable=too-many-branches,too-many-locals
        ...
        for thread in threads:
            ...
            content: typing.Any = typing.cast(workers.TaskResult, thread.result).result
