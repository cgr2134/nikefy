...
TException_contra = typing.TypeVar('TException_contra', bound=BaseException, contravariant=True)

if typing.TYPE_CHECKING:
    import typing_extensions

    class Handler(typing_extensions.Protocol[TException_contra]):  # pylint: disable=too-few-public-methods
        """Common protocol for error handling functions."""

        def __call__(self, exception: TException_contra) -> typing.Any:
            """
            Execute handler.
    ...
    class Parser(typing_extensions.Protocol[TException_contra]):  # pylint: disable=too-few-public-methods
        """Common protocol for context parsers for exceptions."""

        def __call__(self, exception: TException_contra) -> typing.Tuple[typing.Any, ...]:
            """
...
class ErrorHandlers:
    ...
    def register_handler(
            self,
            exception_type: typing.Type[TException_contra],
            handler: 'Handler[TException_contra]',
            *context: typing.Any,
    ) -> None:
        """
    ...
    def register_parser(
            self,
            exception_type: typing.Type[TException_contra],
            parser: 'Parser[TException_contra]',
    ) -> None:
        """
