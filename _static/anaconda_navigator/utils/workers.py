...
class TaskManager(QtCore.QObject):
    ...
    def __init__(self) -> None:
        ...
        self.__workers: 'typing_extensions.Final[typing.Set[TaskWorker]]' = set()
...
class ThreadPoolSingleton(singletons.Singleton[QtCore.QThreadPool]):
...
MANAGER: 'typing_extensions.Final[singletons.Singleton[TaskManager]]' = singletons.SingleInstanceOf(TaskManager)
THREAD_POOL: 'typing_extensions.Final[singletons.Singleton[QtCore.QThreadPool]]' = ThreadPoolSingleton()
