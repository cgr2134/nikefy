...
if typing.TYPE_CHECKING:
    ...
    class SimpleAdvertisementDict(typing_extensions.TypedDict):
...
class CustomStackedWidget(QtWidgets.QStackedWidget):
    ...
    def __init__(self, parent: CompositeAdvertisementWidget) -> None:
        ...
        self.__timer: 'typing_extensions.Final[QtCore.QTimer]' = QtCore.QTimer(self)
...
class CompositeAdvertisementWidget(core.PartnerWidget[CustomStackedWidget]):
    ...
    def __init__(self, definition: 'CompositeAdvertisementDict', settings: core.PartnerSettings) -> None:
        ...
        self.__content: 'typing_extensions.Final[CONTENT]' = definition['advertisements']
