...
if typing.TYPE_CHECKING:
    ...
    class WidgetDict(typing_extensions.TypedDict):
        """
    ...
    class ConfigurationDict(typing_extensions.TypedDict):
...
TWidget_co = typing.TypeVar('TWidget_co', bound='QtWidgets.QWidget', covariant=True)
...
class PartnerSettings:
    ...
    def __init__(self, content: typing.Optional['SettingsDict'] = None) -> None:
        ...
        self.__content: 'typing_extensions.Final[SettingsDict]' = content
...
class PartnerWidget(typing.Generic[TWidget_co], metaclass=abc.ABCMeta):
    ...
    def __init__(self, settings: PartnerSettings, placement: PartnerWidgetPlacement) -> None:
        ...
        self.__placement: 'typing_extensions.Final[PartnerWidgetPlacement]' = PartnerWidgetPlacement(placement)
        self.__settings: 'typing_extensions.Final[PartnerSettings]' = settings
