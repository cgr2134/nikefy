...
class ImportSelectorDialog(  # pylint: disable=too-many-instance-attributes
    ...
    def __init_nucleus_form__(self, form: multiaccount_dialogs.SelectorForm) -> None:
        ...
        if nucleus.NucleusAPI().token.username:
            worker: workers.TaskWorker = nucleus.NucleusAPI().list_environments.worker(  # pylint: disable=no-member
    ...
    def __check_nucleus_fetch(self, result: workers.TaskResult) -> None:
        ...
        try:
            ...
            self.__nucleus_content = {'total': 0}
    ...
    def __process_accept_nucleus(self) -> None:
        ...
        worker: workers.TaskWorker = nucleus.NucleusAPI().download_environment.worker(  # pylint: disable=no-member
    ...
    def __check_nucleus_download(self, result: workers.TaskResult) -> None:
