...
class BackupSelectorDialog(multiaccount_dialogs.PrepopulatedSelectorDialog):  # pylint: disable=too-few-public-methods
    ...
    def __check_local_export(
        ...
        new_worker: workers.TaskWorker = nucleus_tools.clear_environment.worker(
    ...
    def __check_nucleus_inject(self, result: workers.TaskResult) -> None:
        """"""
        try:
            os.remove(result.call.kwargs['source_file'])
        except OSError:
    ...
    def __check_nucleus_create(self, result: workers.TaskResult) -> None:
    ...
    def __check_nucleus_update(self, result: workers.TaskResult) -> None:
