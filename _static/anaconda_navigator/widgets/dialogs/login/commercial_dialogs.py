...
COMMERCIAL_LOGIN_TEXT_CONTAINER = utils.TextContainer(
    ...
    info_frame_text=(
        ...
        utils.Span(
            '" style="color:#43B049;text-decoration: none">Terms of Service'  # pylint: disable=implicit-str-concat
            '</a>. Subscription required. More details <a href="'
        ),
        utils.UrlSpan(
        ...
        utils.Span('" style="color:#43B049;text-decoration: none">here</a>.')
    ),
)
