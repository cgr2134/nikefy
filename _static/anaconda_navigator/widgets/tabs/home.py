...
if typing.TYPE_CHECKING:
    ...
    ApplicationFilter = typing_extensions.Literal['all', 'installed', 'uninstalled', 'updatable']
...
class CheckInstalled:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, target: bool) -> None:
        ...
        self.__target: 'typing_extensions.Final[bool]' = target
...
APPLICATION_FILTERS: (
    'typing_extensions.Final[typing.Mapping[ApplicationFilter, ApplicationFilterDetails]]'
) = {
