...
class SubCommand(SubCommandBase):
    ...
    def direct_get_token(self):
        ...
        for _ in range(3):
            try:
                ...
                user_token = self.get_and_validate_user_token(force_scopes=self.args.force_scopes)
                return user_token
    ...
    def add_parser(self, subparsers):
        ...
        subparser.add_argument('--force-scopes', dest='force_scopes', action='store_true',
