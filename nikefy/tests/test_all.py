...
class TestNikefy(unittest.TestCase):
    ...
    def test_get_nike_products_integration(self):
        ...
        self.assertTrue('Product Name' in data.columns)
        self.assertTrue('Price' in data.columns)
        self.assertTrue('Type' in data.columns)
        self.assertTrue('Description' in data.columns)
        self.assertTrue('Product URL' in data.columns)
